...
export const makeCommandCodeTextGeneration = Effect.fn("makeCommandCodeTextGeneration")(function* (
    ...
    Effect.gen(function* () {
      ...
      const promptResult = yield* Effect.gen(function* () {
        ...
        yield* applyCommandCodeAcpModelSelection({
          ...
          mapError: (cause) =>
            new TextGenerationError({
              operation,
              detail: "Failed to set Command Code model for text generation.",
              cause,
            }),
        });
          ...
          Option.match({
            onNone: () =>
              Effect.fail(
                new TextGenerationError({
                  operation,
                  detail: "Command Code ACP request timed out.",
                }),
              ),
        ...
        Effect.mapError((cause: EffectAcpErrors.AcpError | TextGenerationError) =>
          isTextGenerationError(cause)
            ...
            : new TextGenerationError({
                operation,
                detail: "Command Code ACP request failed.",
                cause,
              }),
        ),
      );
        ...
        return yield* new TextGenerationError({
          ...
          detail:
            promptResult.stopReason === "cancelled"
              ? "Command Code ACP request was cancelled."
              : "Command Code Agent returned empty output.",
        });
      }
      ...
      Effect.mapError((cause) =>
        isTextGenerationError(cause)
          ...
          : new TextGenerationError({
              operation,
              detail: "Command Code ACP text generation failed.",
              cause,
            }),
      ),
      Effect.scoped,
  ...
  return {
    generateCommitMessage,
    generatePrContent: Effect.fn("CommandCodeTextGeneration.generatePrContent")(function* (input) {
    ...
    generateBranchName: Effect.fn("CommandCodeTextGeneration.generateBranchName")(
      function* (input) {
    ...
    generateThreadTitle: Effect.fn("CommandCodeTextGeneration.generateThreadTitle")(
      function* (input) {
