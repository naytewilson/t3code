...
// A square plug glyph for the generic ACP provider. The former ACP wordmark was
// ~2.6:1 and rendered as a sliver in the square icon slots (ModelListRow,
// ProviderInstanceIcon, the provider dialogs); this matches the mobile app,
// which uses a plug for the same driver.
export const ACPIcon: Icon = ({ className, ...props }) => (
  <Plug className={cn(className)} {...props} />
);
